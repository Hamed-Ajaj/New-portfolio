  ...
  return (
    <div className="py-20" id="projects">
       <h1 className="heading">
        ...
        <span className="text-purple">recent RecentProjects</span>
       </h1>
       <div className="flex flex-wrap items-center justify-center p-4 gap-x-16 gap-y-8 mt-10">
          {projects.map(({id,title,des,img,iconLists,link}) => (
            <div key={id} className="sm:h-[41rem] h-[32rem] lg:min-h-[33rem]  flex items-center justify-center sm:w-[570px] w-[90vw]">
